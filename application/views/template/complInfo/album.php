<div class="col-xs-12">
    <div class="row">
        <div class="col-xs-4">
            <div class="box">
                <label for="groupeItem">Groupe</label>
            </div>
        </div>
        <div class="col-xs-8">
            <div class="box">
                <input type="text" name="item_creator" id="groupeItem" maxlength="100 <?php echo isset($item) ? 'value="' . $item['item_creator'] . '"' : ''; ?>" />
            </div>
        </div>
    </div>
</div>
...
<div class="col-xs-12">
    <div class="row">
        ...
        <div class="col-xs-8">
            <div class="box">
                <input type="text" name="track[]" id="trackItem" />
            </div>
        </div>
    </div>
    <div class="row">
